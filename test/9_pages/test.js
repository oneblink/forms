...
define(['BlinkForms', 'BIC'], function (Forms) {
  ...
  suite('9: pages', function () {
    ...
    suite('Pages', function () {
      ...
      test('page 1,2 elements are not visible', function () {
        var form = Forms.current,
        ...
        names.forEach(function (name) {
          ...
          assert.isFalse(view.$el.is(':visible'), name + ' is not visible');
        });
      });
      ...
      test('page 0,2 elements are not visible', function () {
        var form = Forms.current,
      ...
      test('page 0,1 elements are not visible', function () {
        var form = Forms.current,
