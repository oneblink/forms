...
(function() {
  require._config = require.config({
    paths: {
      angular: '//ajax.googleapis.com/ajax/libs/angularjs/1.0.4/angular.min',
      backbone: '//d1c6dfkb81l78v.cloudfront.net/backbonejs/0.9.10/backbone.min',
      jquery: [
        '//d1c6dfkb81l78v.cloudfront.net/jquery/1.9.0/jquery.min',
        '//ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min'
      ],
      q: '//d1c6dfkb81l78v.cloudfront.net/q/0.8.11/q.min',
      underscore: '//d1c6dfkb81l78v.cloudfront.net/underscorejs/1.4.3/u.min',
      jquerymobile: '//d1c6dfkb81l78v.cloudfront.net/jquery.mobile/1.2.0/jqm.min',
      jquerymigrate: '//d1c6dfkb81l78v.cloudfront.net/jquery-migrate/1.1.0/migrate-1.1.0.min',
      rivets: '//d1c6dfkb81l78v.cloudfront.net/rivets/0.4.5/rivets.min',
      mustache: '//d1c6dfkb81l78v.cloudfront.net/mustache/0.7.2/mustache.min'
    },
    shim: {
      angular: {
        exports: 'angular'
